...
$COURSIER_BIN launch -r $LONELYPLANET_RESOLVER -r jitpack -r https://jcenter.bintray.com $TMT_BACKEND_LIB:$TMT_BACKEND_VERSION $AKKA_HTTP_SPRAY_JSON -M org.tmt.Backend -- "$@"
