import { Duration, HttpConnection, HttpLocation, LocationService } from "../../../src/clients/location";
...
describe('LocationService', () => {
  ...
  test('should return location of given component | ESW-308, ESW-310, ESW-311', async () => {
    ...
    expect(mockRequestRes).toBeCalledWith(new Req.Resolve(httpConnection, duration), expect.anything())
  })
  ...
  test('should fetch list all locations for given componentType | ESW-308, ESW-310, ESW-311', async () => {
    ...
    expect(mockRequestRes).toBeCalledWith(new Req.ListByComponentType('Sequencer'), expect.anything())
  })
