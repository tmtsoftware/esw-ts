...
import * as LocationModels from 'jsons/LocationModels.json'
...
describe('Typed Locations', () => {
  test('Akka Location', () => {
    ...
    expect(JSON.parse(JSON.stringify(akkaLocation))).toEqual(LocationModels.AkkaLocation)
  })
  ...
  test('Http Location', () => {
    ...
    expect(JSON.parse(JSON.stringify(httpLocation))).toEqual(LocationModels.HttpLocation)
  })
  ...
  test('Tcp Location', () => {
    ...
    expect(JSON.parse(JSON.stringify(tcpLocation))).toEqual(LocationModels.TcpLocation)
  })
})
