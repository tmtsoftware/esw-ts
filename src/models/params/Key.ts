 ...
 */
export const byteMatrixKey: (name: string, units?: Units) => BaseKey<ByteMatrixKey> =
  keyFactory<ByteMatrixKey>('ByteMatrixKey')

export const intMatrixKey: (name: string, units?: Units) => BaseKey<IntMatrixKey> =
  keyFactory<IntMatrixKey>('IntMatrixKey')

export const longMatrixKey: (name: string, units?: Units) => BaseKey<LongMatrixKey> =
  keyFactory<LongMatrixKey>('LongMatrixKey')

export const shortMatrixKey: (name: string, units?: Units) => BaseKey<ShortMatrixKey> =
  keyFactory<ShortMatrixKey>('ShortMatrixKey')

export const floatMatrixKey: (name: string, units?: Units) => BaseKey<FloatMatrixKey> =
  keyFactory<FloatMatrixKey>('FloatMatrixKey')

export const doubleMatrixKey: (name: string, units?: Units) => BaseKey<DoubleMatrixKey> =
  keyFactory<DoubleMatrixKey>('DoubleMatrixKey')
...
export const shortArrayKey: (name: string, units?: Units) => BaseKey<ShortArrayKey> =
  keyFactory<ShortArrayKey>('ShortArrayKey')

export const floatArrayKey: (name: string, units?: Units) => BaseKey<FloatArrayKey> =
  keyFactory<FloatArrayKey>('FloatArrayKey')
...
export const minorPlanetCoordKey: (name: string, units?: Units) => BaseKey<MinorPlanetCoordKey> =
  keyFactory<MinorPlanetCoordKey>('MinorPlanetCoordKey')

export const cometCoordKey: (name: string, units?: Units) => BaseKey<CometCoordKey> =
  keyFactory<CometCoordKey>('CometCoordKey')
